<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-text>
            <String v-if="editMode" label="Payment ID" v-model="value.paymentId" :editMode="editMode" :inputUI="''"/>
            <String label="Order ID" v-model="value.orderId" :editMode="editMode" :inputUI="''"/>
...
<script>
    ...
    export default {
        name: 'FinancialManagementPayment',
        components:{
        },
        props: {
